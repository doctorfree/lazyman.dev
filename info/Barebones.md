...
Bare bones LazyVim configuration by Traap with a [video introduction](https://youtu.be/xpBoiTIiepc){:target="_blank"}{:rel="noopener noreferrer"}
...
[https://github.com/Traap/barebones](https://github.com/Traap/barebones){:target="_blank"}{:rel="noopener noreferrer"}
