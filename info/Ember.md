...
[https://github.com/danlikestocode/embervim](https://github.com/danlikestocode/embervim){:target="_blank"}{:rel="noopener noreferrer"}

### Dotfyle entry

[https://dotfyle.com/danlikestocode/embervim-nvim](https://dotfyle.com/danlikestocode/embervim-nvim){:target="_blank"}{:rel="noopener noreferrer"}
...
- [declancm/cinnamon.nvim](https://github.com/declancm/cinnamon.nvim){:target="_blank"}{:rel="noopener noreferrer"}
...
- [xiyaowong/transparent.nvim](https://github.com/xiyaowong/transparent.nvim.git){:target="_blank"}{:rel="noopener noreferrer"}
...
- [Mofiqul/vscode.nvim](https://github.com/Mofiqul/vscode.nvim.git){:target="_blank"}{:rel="noopener noreferrer"}
- [folke/which-key.nvim](https://github.com/folke/which-key.nvim){:target="_blank"}{:rel="noopener noreferrer"}
- [danlikestocode/windows.nvim](https://github.com/danlikestocode/windows.nvim.git){:target="_blank"}{:rel="noopener noreferrer"}
...
| ----------- | --- | --- |
|  | # | <Cmd>lua Scroll('#', 1)<CR> |
|  | $ | <Cmd>lua Scroll('$', 0, 1)<CR> |
|  | % | <Plug>(MatchitNormalForward) |
| Nvim builtin | & | :&&<CR> |
|  | * | <Cmd>lua Scroll('*', 1)<CR> |
|  | 0 | <Cmd>lua Scroll('0')<CR> |
|  | G | <Cmd>lua Scroll('G', 0, 1)<CR> |
|  | N | <Cmd>lua Scroll('N', 1)<CR> |
|  | Q |  |
| Nvim builtin | Y | y$ |
...
|  | cs | <Plug>Csurround |
|  | ds | <Plug>Dsurround |
|  | g# | <Cmd>lua Scroll('g#', 1)<CR> |
|  | g* | <Cmd>lua Scroll('g*', 1)<CR> |
|  | gg | <Cmd>lua Scroll('gg')<CR> |
|  | gx | <Plug>NetrwBrowseX |
|  | g% | <Plug>(MatchitNormalBackward) |
|  | h | <Cmd>lua Scroll('h', 0, 1)<CR> |
|  | j | <Cmd>lua Scroll('j', 0, 1)<CR> |
|  | k | <Cmd>lua Scroll('k', 0, 1)<CR> |
|  | l | <Cmd>lua Scroll('l', 0, 1)<CR> |
|  | n | <Cmd>lua Scroll('n', 1)<CR> |
|  | ySS | <Plug>YSsurround |
|  | ySs | <Plug>YSsurround |
|  | yss | <Plug>Yssurround |
|  | yS | <Plug>YSurround |
|  | ys | <Plug>Ysurround |
|  | ze | <Cmd>lua Scroll('ze')<CR> |
|  | zs | <Cmd>lua Scroll('zs')<CR> |
|  | zL | <Cmd>lua Scroll('zL')<CR> |
|  | zH | <Cmd>lua Scroll('zH')<CR> |
|  | zl | <Cmd>lua Scroll('zl', 0, 1)<CR> |
|  | zh | <Cmd>lua Scroll('zh', 0, 1)<CR> |
|  | z+ | <Cmd>lua Scroll('z+', 0, 1)<CR> |
|  | z^ | <Cmd>lua Scroll('z^', 0, 1)<CR> |
|  | z- | <Cmd>lua Scroll('z-', 0, 1)<CR> |
|  | z<CR> | <Cmd>lua Scroll('zt^', 0, 1)<CR> |
|  | z. | <Cmd>lua Scroll('z.', 0, 1)<CR> |
...
|  | { | <Cmd>lua Scroll('{')<CR> |
|  | } | <Cmd>lua Scroll('}')<CR> |
|  | <Right> | <Cmd>lua Scroll('l', 0, 1)<CR> |
|  | <Left> | <Cmd>lua Scroll('h', 0, 1)<CR> |
|  | <Down> | <Cmd>lua Scroll('j', 0, 1)<CR> |
|  | <Up> | <Cmd>lua Scroll('k', 0, 1)<CR> |
|  | <C-E> | <Cmd>lua Scroll('<C-E>', 0, 1)<CR> |
|  | <C-Y> | <Cmd>lua Scroll('<C-Y>', 0, 1)<CR> |
|  | <C-I> | <Cmd>lua Scroll('1<Tab>', 1)<CR> |
|  | <C-O> | <Cmd>lua Scroll('<C-O>', 1)<CR> |
|  | <PageDown> | <Cmd>lua Scroll('<C-F>', 1, 1)<CR> |
|  | <PageUp> | <Cmd>lua Scroll('<C-B>', 1, 1)<CR> |
|  | <C-F> | <Cmd>lua Scroll('<C-F>', 1, 1)<CR> |
|  | <C-B> | <Cmd>lua Scroll('<C-B>', 1, 1)<CR> |
|  | <C-D> | <Cmd>lua Scroll('<C-D>', 1, 1)<CR> |
|  | <C-U> | <Cmd>lua Scroll('<C-U>', 1, 1)<CR> |
