---
layout: post
title: BasicIde Configuration Info
toc: true
post_style: page
---
...
[https://github.com/LunarVim/nvim-basic-ide](https://github.com/LunarVim/nvim-basic-ide){:target="_blank"}{:rel="noopener noreferrer"}

### Lazy managed plugins

- [numToStr/Comment.nvim](https://github.com/numToStr/Comment.nvim){:target="_blank"}{:rel="noopener noreferrer"}
- [ravenxrz/DAPInstall.nvim](https://github.com/ravenxrz/DAPInstall.nvim.git){:target="_blank"}{:rel="noopener noreferrer"}
