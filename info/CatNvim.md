...
Neovim configuration written in the [C programming language](https://en.wikipedia.org/wiki/C_(programming_language)){:target="_blank"}{:rel="noopener noreferrer"}
...
- Installation location:  **`~/.config/lazyman/CatNvim`**


### Git repository

[https://github.com/nullchilly/CatNvim](https://github.com/nullchilly/CatNvim){:target="_blank"}{:rel="noopener noreferrer"}

### Dotfyle entry

[https://dotfyle.com/nullchilly/catnvim](https://dotfyle.com/nullchilly/catnvim){:target="_blank"}{:rel="noopener noreferrer"}
