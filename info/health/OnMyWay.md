---
layout: post
title: OnMyWay Configuration Health Check
toc: true
post_style: page
---

# nvim-OnMyWay Neovim health check
...
- WARNING {trouble.nvim}: unknown key <require>

--------
mason: require("mason.health").check()

mason.nvim ~
- WARNING mason.nvim version v1.5.0
  - ADVICE:
...
- LSP log level : WARN
- Log path: /home/ronnie/.local/state/nvim-OnMyWay/lsp.log
- Log size: 0 KB
...
- OK Parser: lua        ABI: 14, path: /home/ronnie/.local/share/nvim-OnMyWay/lazy/nvim-treesitter/parser/lua.so
- OK Parser: query      ABI: 14, path: /home/ronnie/.local/share/nvim-OnMyWay/lazy/nvim-treesitter/parser/query.so
- OK Parser: vimdoc     ABI: 14, path: /home/ronnie/.local/share/nvim-OnMyWay/lazy/nvim-treesitter/parser/vimdoc.so
