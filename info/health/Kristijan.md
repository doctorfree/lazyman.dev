---
layout: post
title: Kristijan Configuration Health Check
toc: true
post_style: page
---

# nvim-Kristijan Neovim health check
...
- WARNING {orgmode}: unknown key <orgmode_config>
...
- LSP log level : WARN
- Log path: /home/ronnie/.local/state/nvim-Kristijan/lsp.log
- Log size: 0 KB
