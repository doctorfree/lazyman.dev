---
layout: post
title: Shuvro Configuration Health Check
toc: true
post_style: page
---

# nvim-Shuvro Neovim health check
...
lazy.nvim ~
- OK Git installed
- WARNING found existing packages at `/home/ronnie/.local/share/nvim-Shuvro/site/pack/lazy`
...
- Script: /home/ronnie/.local/share/nvim-Shuvro/site/pack/lazy/opt/markdown-preview.nvim/app/server.js
- Script exists: 1
- OK Using node
...
- ERROR cmake_format: the command "cmake-format" is not executable.
- ERROR scalafmt: the command "scalafmt" is not executable.
- ERROR sqlformat: the command "sqlformat" is not executable.
...
- ERROR vint: the command "vint" is not executable.
- ERROR chktex: the command "chktex" is not executable.
...
- ERROR vale: the command "vale" is not executable.
- ERROR shellcheck: the command "shellcheck" is not executable.
- gomodifytags: cannot verify if the command is an executable.
- gostructhelper: cannot verify if the command is an executable.
...
- ERROR c(highlights): ...-linux64/share/nvim/runtime/lua/vim/treesitter/query.lua:259: query: invalid node type at position 242 for language c
  ...
  | [ERROR]:"/home/ronnie/.local/share/nvim-Shuvro/site/pack/lazy/opt/nvim-treesitter/queries/c/highlights.scm", failed to load: ...-linux64/share/nvim/runtime/lua/vim/treesitter/query.lua:259: query: invalid node type at position 242 for language c
- ERROR c(folds): ...-linux64/share/nvim/runtime/lua/vim/treesitter/query.lua:259: query: invalid node type at position 249 for language c
  ...
  | [ERROR]:"/home/ronnie/.local/share/nvim-Shuvro/site/pack/lazy/opt/nvim-treesitter/queries/c/folds.scm", failed to load: ...-linux64/share/nvim/runtime/lua/vim/treesitter/query.lua:259: query: invalid node type at position 249 for language c
- ERROR c(indents): ...-linux64/share/nvim/runtime/lua/vim/treesitter/query.lua:259: query: invalid node type at position 1109 for language c
  ...
  | [ERROR]:"/home/ronnie/.local/share/nvim-Shuvro/site/pack/lazy/opt/nvim-treesitter/queries/c/indents.scm", failed to load: ...-linux64/share/nvim/runtime/lua/vim/treesitter/query.lua:259: query: invalid node type at position 1109 for language c
...
- LSP log level : ERROR
- Log path: /home/ronnie/.local/state/nvim-Shuvro/lsp.log
- Log size: 0 KB
