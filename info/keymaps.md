---
layout: post
title: Neovim Configuration Keymaps Retrieval
toc: false
post_style: page
---

## Neovim configuration keymaps retrieval

Each supported Lazyman Neovim configuration has an information document
auto-generated by the
[scripts/information.sh](https://lazyman.dev/info/information.html)
script. This script calls `scripts/keymaps.sh` to generate
tables of keymaps defined by each configuration.

## Source for scripts/keymaps.sh
