...
| <code>&lt;Plug&gt;MoveCharLeft</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;64_MoveCharHorizontally(-v:count1)&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;MoveCharRight</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;64_MoveCharHorizontally( v:count1)&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;MoveLineHalfPageUp</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;64_MoveLineVertically(-v:count1 * &lt;SNR&gt;64_HalfPageSize())&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;MoveLineHalfPageDown</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;64_MoveLineVertically( v:count1 * &lt;SNR&gt;64_HalfPageSize())&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;MoveLineUp</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;64_MoveLineVertically(-v:count1)&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;MoveLineDown</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;64_MoveLineVertically( v:count1)&lt;CR&gt;</code> |  |
...
| <code>&lt;Plug&gt;(abolish-coerce-word)</code> | <code>&lt;SNR&gt;49_coerce(nr2char(getchar())).'iw'</code> |  |
| <code>&lt;Plug&gt;(abolish-coerce)</code> | <code>&lt;SNR&gt;49_coerce(nr2char(getchar()))</code> |  |
...
| <code>&lt;SNR&gt;40_(wise)</code> | <code>empty(g:v_motion_force) ? 'v' : g:v_motion_force</code> |  |
...
| <code>&lt;SNR&gt;10_</code> | <code>&lt;SNR&gt;10_</code> |  |
| <code>&lt;SNR&gt;10_(save-cursor-pos)</code> | <code>&lt;SNR&gt;10_save_cursor_pos()</code> |  |
| <code>&lt;C-L&gt;</code> | <code>&lt;Plug&gt;MoveCharRight</code> |  |
| <code>Ö</code> | <code>&lt;Cmd&gt;execute v:count . "ToggleTerm"&lt;CR&gt;</code> | Toggle Terminal | 
...
| <code>&lt;Plug&gt;(abolish-coerce)</code> | <code>&lt;SNR&gt;59_coerce(nr2char(getchar()))</code> |  |
...
| <code>&lt;Plug&gt;MoveBlockLeft</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;53_MoveBlockHorizontally(-v:count1)&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;MoveBlockRight</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;53_MoveBlockHorizontally( v:count1)&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;MoveBlockHalfPageUp</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;53_MoveBlockVertically(-v:count1 * &lt;SNR&gt;53_HalfPageSize())&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;MoveBlockHalfPageDown</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;53_MoveBlockVertically( v:count1 * &lt;SNR&gt;53_HalfPageSize())&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;MoveBlockUp</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;53_MoveBlockVertically(-v:count1)&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;MoveBlockDown</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;53_MoveBlockVertically( v:count1)&lt;CR&gt;</code> |  |
...
| <code>&lt;Plug&gt;(VM-Find-Subword-Under)</code> | <code>&lt;SNR&gt;39_Visual('under')</code> |  |
...
| <code>&lt;Plug&gt;(VM-Visual-All)</code> | <code>&lt;SNR&gt;39_Visual('all')</code> |  |
...
| <code>&lt;C-Z&gt;</code> | <code></code> |  |
| <code>&lt;Plug&gt;VgSurround</code> | <code>:&lt;C-U&gt;call &lt;SNR&gt;35_opfunc(visualmode(),visualmode() ==# 'V' ? 0 : 1)&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;VSurround</code> | <code>:&lt;C-U&gt;call &lt;SNR&gt;35_opfunc(visualmode(),visualmode() ==# 'V' ? 1 : 0)&lt;CR&gt;</code> |  |
...
| <code>&lt;Plug&gt;(textobj-line-i)</code> | <code>&lt;SNR&gt;22_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_line.do_by_function("select-i","-","v")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-line-a)</code> | <code>&lt;SNR&gt;22_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_line.do_by_function("select-a","-","v")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-fold-i)</code> | <code>&lt;SNR&gt;22_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_fold.do_by_function("select-i","-","v")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-fold-a)</code> | <code>&lt;SNR&gt;22_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_fold.do_by_function("select-a","-","v")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-parameter-i)</code> | <code>&lt;SNR&gt;22_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_parameter.do_by_function("select-i","-","v")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-parameter-a)</code> | <code>&lt;SNR&gt;22_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_parameter.do_by_function("select-a","-","v")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-parameter-greedy-i)</code> | <code>&lt;SNR&gt;22_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_parameter.do_by_function("select-i","greedy","v")&lt;CR&gt;</code> |  |
...
| <code>&lt;Plug&gt;(textobj-indent-i)</code> | <code>&lt;SNR&gt;22_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-i","-","v")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-indent-a)</code> | <code>&lt;SNR&gt;22_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-a","-","v")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-indent-same-i)</code> | <code>&lt;SNR&gt;22_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-i","same","v")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-indent-same-a)</code> | <code>&lt;SNR&gt;22_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-a","same","v")&lt;CR&gt;</code> |  |
| <code>&lt;SNR&gt;22_(save-cursor-pos)</code> | <code>&lt;SNR&gt;22_save_cursor_pos()</code> |  |
...
| <code>&lt;Plug&gt;(matchup-Z%)</code> | <code>&lt;SNR&gt;17_(matchup-Z%)</code> |  |
| <code>&lt;SNR&gt;17_(matchup-Z%)</code> | <code>:&lt;C-U&gt;call matchup#motion#jump_inside_prev(1)&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(matchup-z%)</code> | <code>&lt;SNR&gt;17_(matchup-z%)</code> |  |
| <code>&lt;SNR&gt;17_(matchup-z%)</code> | <code>:&lt;C-U&gt;call matchup#motion#jump_inside(1)&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(matchup-[%)</code> | <code>&lt;SNR&gt;17_(matchup-[%)</code> |  |
| <code>&lt;Plug&gt;(matchup-]%)</code> | <code>&lt;SNR&gt;17_(matchup-]%)</code> |  |
| <code>&lt;SNR&gt;17_(matchup-[%)</code> | <code>:&lt;C-U&gt;call matchup#motion#find_unmatched(1, 0)&lt;CR&gt;</code> |  |
| <code>&lt;SNR&gt;17_(matchup-]%)</code> | <code>:&lt;C-U&gt;call matchup#motion#find_unmatched(1, 1)&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(matchup-g%)</code> | <code>&lt;SNR&gt;17_(matchup-g%)</code> |  |
| <code>&lt;SNR&gt;17_(matchup-g%)</code> | <code>:&lt;C-U&gt;call matchup#motion#find_matching_pair(1, 0)&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(matchup-%)</code> | <code>&lt;SNR&gt;17_(matchup-%)</code> |  |
| <code>&lt;SNR&gt;17_(matchup-%)</code> | <code>:&lt;C-U&gt;call matchup#motion#find_matching_pair(1, 1)&lt;CR&gt;</code> |  |
...
| <code>&lt;Plug&gt;(matchup-%)</code> | <code>:&lt;C-U&gt;call matchup#motion#op('%')&lt;CR&gt;</code> |  |
| <code>&lt;C-Z&gt;</code> | <code></code> |  |
| <code>&lt;Plug&gt;(textobj-line-i)</code> | <code>&lt;SNR&gt;11_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_line.do_by_function("select-i","-","o")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-line-a)</code> | <code>&lt;SNR&gt;11_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_line.do_by_function("select-a","-","o")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-indent-i)</code> | <code>&lt;SNR&gt;11_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-i","-","o")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-indent-a)</code> | <code>&lt;SNR&gt;11_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-a","-","o")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-indent-same-i)</code> | <code>&lt;SNR&gt;11_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-i","same","o")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-indent-same-a)</code> | <code>&lt;SNR&gt;11_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-a","same","o")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-parameter-i)</code> | <code>&lt;SNR&gt;11_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_parameter.do_by_function("select-i","-","o")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-parameter-a)</code> | <code>&lt;SNR&gt;11_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_parameter.do_by_function("select-a","-","o")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-parameter-greedy-i)</code> | <code>&lt;SNR&gt;11_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_parameter.do_by_function("select-i","greedy","o")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;luasnip-expand-repeat</code>|  |  |
...
| <code>&lt;Plug&gt;(textobj-fold-i)</code> | <code>&lt;SNR&gt;11_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_fold.do_by_function("select-i","-","o")&lt;CR&gt;</code> |  |
| <code>&lt;Plug&gt;(textobj-fold-a)</code> | <code>&lt;SNR&gt;11_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_fold.do_by_function("select-a","-","o")&lt;CR&gt;</code> |  |
| <code>&lt;SNR&gt;11_(save-cursor-pos)</code> | <code>&lt;SNR&gt;11_save_cursor_pos()</code> |  |
