...
| <code>%</code> | <code>&lt;Plug&gt;(matchup-%)</code> |
 ...
 | Comment toggle linewise| <code>g%</code> | <code>&lt;Plug&gt;(matchup-g%)</code> |
 ...
 | Comment toggle linewise| <code>&lt;2-LeftMouse&gt;</code> | <code>&lt;Plug&gt;(matchup-double-click)</code> |
 ...
 | | <code>&lt;SNR&gt;44_(wise)</code> | <code>empty(g:v_motion_force) ? 'v' : g:v_motion_force</code> |
 ...
 | | <code>&lt;Plug&gt;MoveCharLeft</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;34_MoveCharHorizontally(-v:count1)&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;MoveCharRight</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;34_MoveCharHorizontally( v:count1)&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;MoveLineHalfPageUp</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;34_MoveLineVertically(-v:count1 * &lt;SNR&gt;34_HalfPageSize())&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;MoveLineHalfPageDown</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;34_MoveLineVertically( v:count1 * &lt;SNR&gt;34_HalfPageSize())&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;MoveLineUp</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;34_MoveLineVertically(-v:count1)&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;MoveLineDown</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;34_MoveLineVertically( v:count1)&lt;CR&gt;</code> |
 ...
 | | <code>&lt;SNR&gt;16_</code> | <code>&lt;SNR&gt;16_</code> |
 | | <code>&lt;SNR&gt;16_(save-cursor-pos)</code> | <code>&lt;SNR&gt;16_save_cursor_pos()</code> |
 | | <code>&lt;Plug&gt;(abolish-coerce-word)</code> | <code>&lt;SNR&gt;12_coerce(nr2char(getchar())).'iw'</code> |
 | | <code>&lt;Plug&gt;(abolish-coerce)</code> | <code>&lt;SNR&gt;12_coerce(nr2char(getchar()))</code> |
...
| <code>#</code> | <code>y?\V&lt;C-R&gt;"&lt;CR&gt;</code> |
 ...
 | Comment toggle linewise (visual)| <code>g&lt;Plug&gt;(dial-decrement)</code> | <code>&lt;Cmd&gt;lua require"dial.command".select_augend_gvisual()&lt;CR&gt;&lt;Cmd&gt;let &opfunc="dial#operator#decrement_gvisual"&lt;CR&gt;g@gv</code> |
 ...
 | | <code>&lt;Plug&gt;(textobj-fold-i)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_fold.do_by_function("select-i","-","v")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-fold-a)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_fold.do_by_function("select-a","-","v")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-indent-i)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-i","-","v")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-indent-a)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-a","-","v")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-indent-same-i)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-i","same","v")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-indent-same-a)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-a","same","v")&lt;CR&gt;</code> |
 ...
 | | <code>&lt;Plug&gt;(textobj-line-i)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_line.do_by_function("select-i","-","v")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-line-a)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_line.do_by_function("select-a","-","v")&lt;CR&gt;</code> |
 ...
 | | <code>&lt;Plug&gt;(textobj-parameter-i)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_parameter.do_by_function("select-i","-","v")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-parameter-a)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_parameter.do_by_function("select-a","-","v")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-parameter-greedy-i)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_parameter.do_by_function("select-i","greedy","v")&lt;CR&gt;</code> |
 | | <code>&lt;SNR&gt;34_(save-cursor-pos)</code> | <code>&lt;SNR&gt;34_save_cursor_pos()</code> |
 | | <code>&lt;Plug&gt;(abolish-coerce)</code> | <code>&lt;SNR&gt;27_coerce(nr2char(getchar()))</code> |
 ...
 | | <code>&lt;Plug&gt;MoveBlockLeft</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;26_MoveBlockHorizontally(-v:count1)&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;MoveBlockRight</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;26_MoveBlockHorizontally( v:count1)&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;MoveBlockHalfPageUp</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;26_MoveBlockVertically(-v:count1 * &lt;SNR&gt;26_HalfPageSize())&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;MoveBlockHalfPageDown</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;26_MoveBlockVertically( v:count1 * &lt;SNR&gt;26_HalfPageSize())&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;MoveBlockUp</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;26_MoveBlockVertically(-v:count1)&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;MoveBlockDown</code> | <code>:&lt;C-U&gt; silent call &lt;SNR&gt;26_MoveBlockVertically( v:count1)&lt;CR&gt;</code> |
 ...
 | Comment toggle linewise (visual)| <code>&lt;Plug&gt;(dial-decrement)</code> | <code>&lt;Cmd&gt;lua require"dial.command".select_augend_visual()&lt;CR&gt;&lt;Cmd&gt;let &opfunc="dial#operator#decrement_visual"&lt;CR&gt;g@gv</code> |
 ...
 | | <code>&lt;C-Z&gt;</code> | <code></code> |
 | | <code>&lt;Plug&gt;VgSurround</code> | <code>:&lt;C-U&gt;call &lt;SNR&gt;8_opfunc(visualmode(),visualmode() ==# 'V' ? 0 : 1)&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;VSurround</code> | <code>:&lt;C-U&gt;call &lt;SNR&gt;8_opfunc(visualmode(),visualmode() ==# 'V' ? 1 : 0)&lt;CR&gt;</code> |
 | 
...
| <code>%</code> | <code>&lt;Ignore&gt;&lt;Plug&gt;(matchup-%)</code> |
 ...
 | | <code>w</code> | <code>&lt;Plug&gt;WordMotion_w</code> |
 | | <code>z%</code> | <code>&lt;Plug&gt;(matchup-z%)</code> |
 | | <code>&lt;Plug&gt;(textobj-parameter-i)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_parameter.do_by_function("select-i","-","o")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-parameter-a)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_parameter.do_by_function("select-a","-","o")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-parameter-greedy-i)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_parameter.do_by_function("select-i","greedy","o")&lt;CR&gt;</code> |
 ...
 | | <code>&lt;Plug&gt;(textobj-line-i)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_line.do_by_function("select-i","-","o")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-line-a)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_line.do_by_function("select-a","-","o")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-indent-i)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-i","-","o")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-indent-a)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-a","-","o")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-indent-same-i)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-i","same","o")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-indent-same-a)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_indent.do_by_function("select-a","same","o")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-fold-i)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_fold.do_by_function("select-i","-","o")&lt;CR&gt;</code> |
 | | <code>&lt;Plug&gt;(textobj-fold-a)</code> | <code>&lt;SNR&gt;34_(save-cursor-pos):&lt;C-U&gt;call g:__textobj_fold.do_by_function("select-a","-","o")&lt;CR&gt;</code> |
 | | <code>&lt;SNR&gt;34_(save-cursor-pos)</code> | <code>&lt;SNR&gt;34_save_cursor_pos()</code> |
