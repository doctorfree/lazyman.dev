---
layout: post
title: Neovim Install Source Code
toc: false
post_style: page
---
...
During initialization the `lazyman` command runs the `scripts/install_neovim.sh`
script to install Neovim, dependencies, and tools.
